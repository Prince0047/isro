export default {
  heroheader: 'Department of space, Indian Space Research Organisation',
  updates: [
    {
      id: 1,
  ...
  launchers: {
    hero: {
      heading: 'Launchers are used to carry spacecraft to space.',
      text1:
  ...
  footer: {
    text: 'Our vision is to harness space technology for national development, while pursuing space science research and planetary exploration.',
  },
};
